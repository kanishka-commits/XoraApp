export const features = [
    {
      ...
      text: "Learn how to perform basic car care tasks yourself with our step-by-step video guides.",
      button: {
    ...
    },
    {
      ...
      text: "The app's community can offer advice, recommendations, and support, making you feel secure as a car owner.",
      button: {
  ...
  export const faq = [
    {
      ...
      answer:
        "We offer a wide range of automotive services, including oil changes, brake repairs, tire rotations, engine diagnostics, transmission repairs, and more.",
    },
    {
      id: "1",
      question: "Do you offer emergency roadside assistance?",
      answer:
        "Yes, we offer 24/7 emergency roadside assistance to our customers. If you break down, simply call our hotline and we'll send a technician to your location.",
    },
    {
      id: "2",
      question: "Do you accept insurance?",
      answer:
        "Yes, we accept most major insurance providers. Please contact us to verify your insurance coverage.",
    },
    {
      id: "3",
      question: "How do I know if my car needs a tune-up?",
      answer:
        "If your car is experiencing problems such as rough idling, decreased fuel efficiency, or difficulty starting, it may need a tune-up. Tune-ups typically involve replacing spark plugs, air filters, and fuel filters, as well as adjusting the ignition timing.",
    },
    {
      id: "4",
      question: "What are your hours of operation?",
      answer:
        "Our hours of operation are [Monday-Friday: 8 AM - 6 PM, Saturday: 9 AM - 3 PM]. Please call us for any changes.",
    },
    {
      id: "5",
      question: "How long does a typical car repair take?",
      answer:
        "The time it takes to complete a car repair can vary depending on the nature of the problem and the complexity of the repair. However, we will always provide you with an estimated time frame for your repair.",
    },
    {
      id: "6",
      question: "How can I schedule an appointment?",
      answer:
        "You can schedule an appointment online or by calling our service department. We will do our best to accommodate your schedule.",
    },
    {
      id: "7",
      question: "Do you offer warranties on your repairs?",
      answer:
        "Yes, we offer warranties on most of our repairs. Please speak with our service advisors for more information.",
    },
    {
      id: "8",
      question: "What is your customer satisfaction policy?",
      answer:
        "We are committed to providing excellent customer service. If you are not satisfied with your repair, please let us know and we will do our best to resolve the issue.",
    },
    {
      id: "9",
      question: "How can I provide feedback about my experience?",
      answer:
        "You can provide feedback by calling our service department or by completing our online customer satisfaction survey.",
    },
  ];
  ...
  export const testimonials = [
    {
      ...
      comment:
        "This app has been a lifesaver! The AI diagnostics caught a minor issue before it became a major problem. Highly recommend.",
    },
    {
      id: "1",
      name: "Mark Erixon",
      ...
      comment:
        "I love the community aspect of this app. I've gotten great advice and recommendations from other car owners.",
    },
    {
      id: "2",
      name: "Melanie Hurst",
    ...
    },
    {
      ...
      comment:
        "The on-demand services are fast and reliable. I've used them a few times, and I've always been satisfied.",
    },
    {
      id: "4",
      name: "Becky Snider",
      ...
      comment:
        "The app is easy to use, but I'd like to see more customization options.",
    },
    {
      id: "5",
      name: "Jim Bradley",
      ...
      comment:
        "The AI diagnostics could be more in-depth. Sometimes it misses minor issues.",
    },
  ];
